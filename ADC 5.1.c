...
int main(void){
	...
	uint32_t 	delay = 50, // 50 * 10 ms = 500 ms, 1000 ms / 500 ms = 2 Hz // this is a multiplier used for SysTick = half of delay 
	...
	while(count < 100){															// run program for fixed number of steps/samples
		...
		SysTick_Wait10ms(delay);									// halfdelay*10ms
